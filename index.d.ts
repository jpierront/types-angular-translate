...
declare const exportedString: "translate";
export default exportedString;

export type ITranslationTable = angular.translate.ITranslationTable;
export type ILanguageKeyAlias = angular.translate.ILanguageKeyAlias;
export type IStorage = angular.translate.IStorage;
export type IStaticFilesLoaderOptions = angular.translate.IStaticFilesLoaderOptions;
export type IPartialLoader<T> = angular.translate.IPartialLoader<T>;
export type ITranslatePartialLoaderService = angular.translate.ITranslatePartialLoaderService;
export type ITranslatePartialLoaderProvider = angular.translate.ITranslatePartialLoaderProvider;
export type ITranslateService = angular.translate.ITranslateService;
export type ITranslateProvider = angular.translate.ITranslateProvider;
